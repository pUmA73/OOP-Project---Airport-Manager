...
public:
	Employee() : firstName(nullptr), lastName(nullptr), age(0), experience(0), salary(0) {}
...
private:	
	...
	String company;
public:
	Pilot() : license(nullptr), company(nullptr), Employee() {}
